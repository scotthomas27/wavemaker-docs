...
// tag::export-to-device[]
Click the image:../images/save-file.png[Save file,width=20,height=20] icon save the current project to your device.
...
Read the information in the xref:backup-import-export.adoc[Backup, import and export] chapter.
