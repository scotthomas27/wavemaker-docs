...
You can also use the Help button (image:help-icon.png[Help,width=20,height=20]) to access this documentation.
...
From this page, you can access or delete any project in the list or you can start a new project by using the 'New book' button: image:new-book-icon.png[New book,width=20,height=20]
...
You can access or delete any mindmap from the list, or use the image:new-mindmap-icon.png[New mindmap,width=20,height=20] icon to add a new mindmap.
...
You can access or delete any snowflake from the list, or use the image:new-snowflakes-icon.png[New snowflake,width=20,height=20] icon to add a new snowflake.
...
You can access or delete any timeline from the list, or use the image:new-timelines-icon.png[New timeline,width=20,height=20] icon to add a new timeline.
...
You can access or delete any grid planner from the list, or use the image:new-grid-planner.png[New grid planner,width=20,height=20] icon to add a new grid planner.
...
image::cards-interface.png[The Cards interface]
...
Click the image:settings-icon.png[Settings icon,width=20,height=20] to open a dialogue box that contains many settings with which you can control your experience with Wavemaker.

Review the image below to see the available options.

image::wm-settings.png[Settings box]
...
image::close-project.png[Close Project warning]
